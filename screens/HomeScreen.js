...
export default class HomeScreen extends React.Component {
  ...
  getMovie = () => {
    const url = "http://d959883daf89.ngrok.io/get-movie";
  ...
  likedMovie = () => {
    const url = "http://d959883daf89.ngrok.io/liked-movie";
  ...
  unlikedMovie = () => {
    const url = "http://d959883daf89.ngrok.io/unliked-movie";
  ...
  notWatchedMovie = () => {
    const url = "http://d959883daf89.ngrok.io/not-watched-movie";
            ...
            <View style={styles.subBottomContainer}>
              ...
              <View style={styles.lowerBottomContainer}>
                ...
                <View style={styles.buttonContainer}>
                  ...
                  >
                    <Text style={styles.buttonText}>Not Watched Movie</Text>
                  </TouchableOpacity>
                </View>
              </View>
            </View>
